...
insert into scam_info values(1,'BMTC scam', 'Suresh', 20, 2222.548, 2015, '2015-08-10', 'Not declared', 2015-2016, 'inactive');  
insert into scam_info values(2, 'PWD scam', 25, 2018, '2018-04-27', 2018-2022, 'Inactive', '2022-07-24', 'Andra Pradesh');  
insert into scam_info values(3, '2022-01-25', 2024, '5yearsofimprisonment', '2024-08-06', 'Tamilnadu');
insert into scam_info values(4, 'Forest scam', 'Girish', '2015-08-10', 56000.247, 2015, 'Investigation', 2016, 2015); 
insert into scam_info values(5, 'Railway scam', 'Prakash', 78, 555555.6897, 2017, '2018-4-09', 'active', '2022-10-09', 'Kerala');
...
update scam_info set reported_state = 'Madhya Pradesh' where scam_id = 15;
